export const LogoCloudOurTeamSection = () => {
    ...
    <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
      <div className="relative isolate overflow-hidden bg-zinc-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
        <h2 className="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">
          Empresas e organizações que confiam no Parceiros do Bem
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-lg/8 text-gray-300">
          Nossos parceiros institucionais apoiam a transformação social e colaboram ativamente para ampliar o impacto positivo na comunidade.
        </p>
