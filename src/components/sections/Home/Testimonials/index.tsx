...
import { featuredTestimonial, testimonials } from "./constants"
...
export default function Testimonials() {
  return (
    <section id="testimonials" className="relative isolate bg-white pt-24 pb-32 sm:pt-32">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-base/7 font-semibold text-rose-600">Depoimentos</h2>
          <p className="mt-2 text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">
            Milhares de pessoas já fazem parte dessa transformação
          </p>
        </div>
